...
import numpy as np
import cv2
from student_edit import image_synthesis, image_texture
import argparse
...
def transfer(args):
    ...
    if args['input'] is None or args['transfersource'] is None:
        ...
        path_mask = '/Users/glitteri/Documents/GitHub/project4-texture-glitteri13/data/images/mask.jpg'
        ...
        output = image_texture(input, transfersource, outsize, tilesize, overlapsize, n_iterations, mask, args["quiet"])
